...
class Points_Sampler(nn.Layer):
    ...
    def forward(self, points_xyz, features):
        ...
        for fps_sample_range, sampler, npoint in zip(
            ...
            fps_idx = sampler(sample_points_xyz, sample_features,npoint)
...
class DFPS_Sampler(nn.Layer):
    ...
    def forward(self, points, features, npoint):
        ...
        fps_idx = furthest_point_sample(points, npoint)
        return fps_idx


class FFPS_Sampler(nn.Layer):
    """FFPS_Sampler.
    ...
    def forward(self, points, features, npoint):
        ...
        features_for_fps = paddle.concat([points, features.transpose((1, 2))], axis=2)
...
class FS_Sampler(nn.Layer):
    ...
    def forward(self, points, features, npoint):
        ...
        fps_idx = paddle.concat([fps_idx_ffps, fps_idx_dfps], axis=1)
        return fps_idx
